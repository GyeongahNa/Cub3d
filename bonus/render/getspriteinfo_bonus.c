...
/*   Updated: 2020/09/06 11:23:00 by gna              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		checksprite(void)
{
	...
	{
		if (g_imap[g_rayinfo[columnid]->map_y]\
			[g_rayinfo[columnid]->map_x] == 2 ||
		(g_imap[g_rayinfo[columnid]->map_y][g_rayinfo[columnid]->map_x] == 3))
			issprite = 1;
		columnid++;
	}
