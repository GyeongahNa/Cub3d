...
/*   Updated: 2020/09/06 11:30:35 by gna              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "header/savingbmp_bonus.h"
...
int				render(int argc)
{
	...
	renderlifebar(g_window_width / 20 * 15, g_window_width / 20 * 18,
		g_window_height / 20 * 17, g_window_height / 20 * 17 +
		g_window_width / 20);
	renderhud();
